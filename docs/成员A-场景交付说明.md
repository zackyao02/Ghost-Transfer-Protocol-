...
- 依据美术规范“黑暗区域保留冷蓝灰补光”，提高环境补光、石板可读性和天空背景亮度，减弱镜头暗角；夜景仍以炭黑为基底。
- 两侧小神龛增加空的 Ghost 义体接口舱、数据环和导管，祭坛增加接点，让“记忆—机壳—换壳”主题在没有角色 Prefab 时也能从环境看出来。
- 降低前景数据雨密度和线条长度，避免遮住神龛、敌人和 HUD。
- 团队或品牌名“机壳工程队”未在当前仓库文档中找到；本修订按文档明确的原创东方赛博神社与义体换壳设定处理，没有加入未定义的 Logo 或文字。